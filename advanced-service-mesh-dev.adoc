...
**In case you haven’t done Module 1 or Module 2 today**, or you didn’t quite complete them, you should deploy the bankdemo application and microservices by executing the following shell scripts in CodeReady Workspaces Terminal:
