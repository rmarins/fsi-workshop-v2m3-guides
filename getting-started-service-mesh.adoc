...
https://github.com/rmarins/fsi-workshop-v2m3-labs.git
...
----
cd $CHE_PROJECTS_ROOT/fsi-workshop-v2m3-labs && git checkout ocp-4.5
----

=== Remove other projects

If you've completed other modules today (such as `fsi-workshop-v2m1-labs`), remove them from your workspace by right-clicking on the project name in the explorer and choose *Delete* and accept the warning. Be sure not to delete the new project you just imported for this lab!
