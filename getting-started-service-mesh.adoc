...
[NOTE]
====
Make sure you close the **Add to Workspace** dialog that appears on the bottom-right after the import is complete. Click the **[X]**
to close this dialog.
====

image::crw-clone-close.png[crw, 400, align="right"]
