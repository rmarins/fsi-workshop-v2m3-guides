...
----
oc apply -n {{ USER_ID}}-bookinfo -f /projects/fsi-workshop-v2m3-labs/istio/bookinfo.yaml
----
...
[source,shell, role="copypaste"]
----
oc apply -n {{ USER_ID}}-bookinfo -f /projects/fsi-workshop-v2m3-labs/istio/bookinfo-gateway.yaml
----
...
[source,shell, role="copypaste"]
----
oc apply -n {{ USER_ID}}-bookinfo -f /projects/fsi-workshop-v2m3-labs/istio/destination-rule-all.yaml
----
